...
const submitForm = async () => {
    ...
    try {
        ...
        error.value = e?.response?.data?.message || 'Greška pri čuvanju porudžbine.';
    } finally {
        saving.value = false;
    }
};
...
<template>
    <div class="max-w-3xl">
        ...
        <form @submit.prevent="submitForm" class="bg-white border rounded-xl p-5 shadow-sm space-y-6">
            <!-- Kupac -->
            <section>
                ...
                <div class="grid sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input v-model="form.customer.fullName" required class="w-full border rounded-lg px-3 py-2" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="email" v-model="form.customer.email" class="w-full border rounded-lg px-3 py-2" />
                    </div>
